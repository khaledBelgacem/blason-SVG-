...
public class Line extends Vector {
	...
	/***
	 * 
	 * Retour de l'ordonn�e � l'origine de la droite.
	 * 
	 * @return Une ordonn�e � l'origine non null, sinon la droite n'est pas une fonction.
	 */
	...
	/***
	 * 
	 * Retourne l'abcisse en fonction de l'ordonn�e.
	 * 
	 * @param y Une ordonn�e quelconque
	 * @return L'abscisse au point d'ordonn�e y
	 */
	...
	/***
	 * 
	 * Retourne l'ordonn�e en fonction de l'abscisse.
	 * 
	 * @param x Une abscisse quelconque
	 * @return L'ordonn�e au point d'abscisse x.
	 */
