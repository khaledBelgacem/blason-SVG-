...
public class Vector {
	...
	/***
	 * Retourne l'ordonn�e du vecteur.
	 * @return l'ordonn�e du vecteur
	 */
	public double y() {
		return y;
	}
	 ...
	 * @return Le point � la base du vecteur
	 */
	public Point a() {
		return a;
	}
	 ...
	 * @return Le point � la pointe du vecteur
	 */
	public Point b() {
		return b;
	}
	...
	/***
	 * Longueur du vecteur au carr�.
	 * @return le carr� de la longueur du vecteur
	 */
	...
	/***
	 * Homoth�tie sur le vecteur.
	 * Seul la pointe est d�plac�e lors de l'op�ration, la base reste inchang�e.
	 * @param val Coefficient � appliquer sur le vercteur
	 */
