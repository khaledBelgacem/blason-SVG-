...
public class ConvexPolygon {
	...
	/***
	 * 
	 * Construteur de polygone convexe � partir d'un ensemble de points
	 * 
...
//	}
	...
	/***
	 * 
	 * V�rifie si deux double sont de m�me signe. 
	 * 
	 * @param d Un double
	 * @param c Un autre double
	 * @return Vrai si les dexu doubles sont de m�me signe, faux sinon
	 */
	 ...
	 * � l'enveloppe convexe d'un autre ensemble de points.
	 * 
	 * @param points Liste des points � envelopper
	 * @return Une liste de points correspondant � l'enveloppe convexe
	 */
