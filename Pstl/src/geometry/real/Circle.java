...
public class Circle {
	 ...
	 * 
	 * @param x La coordonn�e en abscisse du centre du cercle
	 * @param y La coordonn�e en ordonn�e du centre du cercle
	...
	/***
	 * 
	 * Permet de v�rifier si un point est inclus dans le cercle (int�rieur + bordure)
	 * Attention ! L'impr�cision due � l'utilisation des doubles est conserv�e mais 
	 * dans le cas o� le carr� de la distance et le carr� du rayon diff�rent de moins
	 * d'un milliardi�me alors on consi�re que le point est dans le cercle.  
	 * 
	...
	/***
	 * 
	 * Permet de v�rifier si un point est sur le cercle
	 * 
	 * @param p
	...
	/***
	 * 
	 * Permet de v�rifier si un ensemble est inclus dans la cercle (int�rieur + bordure)
	 * 
...
//	}
	...
	/***
	 * 
	 * Permet de d�terminer les intersections en le cercle courrant et un autre cercle.
	 * 
	 * @param c Un cercle � tester
	...
	/***
	 * 
	 * Permet de d�terminer les points d'intersection entre les le cercle courrant et une ligne.
	 * 
	 * @deprecated Dans le cas o� la line n'est pas une fonction affine les r�sultats peuvent conduire � des erreurs. (A corriger)
	 * 
	 * @param l Une ligne � tester
	 * @return Une liste de points d'intersection
	 */
	...
	/***
	 * 
	 * Calcul le cercle circonscrit � 3 points
	 * 
	 * @param a Un premier point
	 * @param b Un second point
	 * @param c Un trois�me point
...
//	}
	...
	/***
	 * 
	 * Retourne le cercle minimal � un ensemble de 3 points.
	 * Ce cercle minimal est soit le cercle de diam�tre le plus entre toutes les paires
	 * de points dans le cas d'un triangle obtus et rectangle ou sinon le cercle circonscrit � celui-ci.  
	 * 
	 * @param a Un premier point
	 * @param b Un second point
	 * @param c Un trois�me point
